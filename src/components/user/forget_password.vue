                ...
                <form @submit.prevent="login">
                    ...
                    <div class="login_c">
                        ...
                        <div class="register_content">
                            <div class="register_content_left">
                                <iframe
                                    src="https://lottie.host/embed/099d024d-9496-4be7-bd97-61ab6a69b621/V5m6VWYLIb.json"></iframe>
                 ...
                 -->
                            ...
                            <div class="register_content_right">
                                ...
                                <div class="box_register_content_right">
                                    <input type="password" v-model="new_password_confirmation" class="register_input"
                                        id="password" placeholder="Confirmez votre nouveau mot de passe">
                                </div>
